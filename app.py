...
#Welcoming message
st.write("I'm your Data Science Expert and I can analyse CSV files. Should we start?")
...
with st.sidebar:
    ...
    st.caption("<p style ='text-align:center'> ~Dafni P.</p>",unsafe_allow_html=True )
